...
syn keyword pirOp inspect new root_new typeof get_repr find_method
syn keyword pirOp defined exists delete elements push pop unshift shift
syn keyword pirOp splice setprop getprop delprop prophash freeze thaw
syn keyword pirOp add_multi find_multi register unregister box iter morph
syn keyword pirOp clone exchange set assign setref deref setp_ind
syn keyword pirOp setn_ind sets_ind seti_ind copy null cleari clearn
syn keyword pirOp clears clearp ord chr chopn concat repeat length
syn keyword pirOp bytelength pin unpin substr index sprintf stringinfo
